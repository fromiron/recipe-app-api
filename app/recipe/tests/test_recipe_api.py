...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_delete_recipe_other_users_recipe_error(self):
        """test trying tp de;ete another users recipe gives error"""
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_create_tag_on_update(self):
        ...
        self.assertEqual(new_tag, recipe.tags.all()[0])
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai Vegetable Curry')
        r2 = create_recipe(user=self.user, title='Aubergine with Tahini')
        in1 = Ingredient.objects.create(user=self.user, name='Lemon')
